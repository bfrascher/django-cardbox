...
urlpatterns = [
    ...
    url(r'^collection/edit/(?P<collection_id>[0-9]+)/$',
        views.edit_collection, name='edit_collection'),
    url(r'^collection/delete/(?P<collection_id>[0-9]+)/$',
        views.delete_collection, name='delete_collection'),
    url(r'^collection/(?P<collection_id>[0-9]+)/$',
    ...
    url(r'^ajax/collectionentries/(?P<collection_id>[0-9]+)/update$',
        views.update_collection_entries, name='update_collection_entries'),
